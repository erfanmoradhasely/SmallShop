...
namespace SmallShop.Presentation.Api.Middlewares;
...
public class ApiCustomExceptionHandlerMiddleware
{
    ...
    private readonly IAppLogger<ApiCustomExceptionHandlerMiddleware> _logger;

    public ApiCustomExceptionHandlerMiddleware(RequestDelegate next,
        IHostEnvironment env,
        IAppLogger<ApiCustomExceptionHandlerMiddleware> logger)
    {
        _next = next;
        _env = env;
        _logger = logger;
